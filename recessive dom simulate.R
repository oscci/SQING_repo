...
setwd("/Users/dorothybishop/Dropbox/Projects2016/SQING/SQING R scripts")
#sets working directory: this syntax works with Mac
...
# Plot the chart.
tiff("Plot4.tiff", width = 6, height = 4, units = 'in', res = 300)

pie(x,labels,cex=0.75)
box()
# Save the file.
