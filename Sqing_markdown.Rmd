...
# the information we need
  ...
  colnames(allstudy)=c('Study', 'Authors', 'Title', 'DOI', 'Sample', 'Sample_N', 'Subgroups', 
                       ...
                       'Detect_ES_80d', 'Neuro_Method', 'X6', 'X7', 'X8', 'X9', 'X10','X11','X12','X13','X14','X15',
                       'X16','Journal','X19','X20')
...
#-------------------------------------------------------------------------------
  ...
  #move cols for text account of sample, and subgroups to cols 63 and 64
  #(historical reasons for this: these cols will be used for Ns for discovery/replication)
  allstudy[i,63]<-allstudy[i,6]
  allstudy[i,64]<-allstudy[i,7]
...
myNtable$FullCorrect<-c(1,1,0,0,1,0,1,0,1,1,0,0,0,1,2,2,2,2,0,0,2,1,0,0,2,0,0,1,2,2)
#-----------------------------------------------------------------------------
